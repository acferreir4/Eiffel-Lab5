...
extern EIF_TYPED_VALUE F1293_11588(EIF_REFERENCE);
extern void F1293_11589(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1293_11588 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1293_11589 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1292, Current, 0, 0, 18148);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1292, Current, 18148);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8428, 0xF8000599, 0); /* implementation */
