...
extern EIF_TYPED_VALUE F1121_9460(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1121_9461(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1121_9462(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1121_9460 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1120, Current, 0, 0, 15477);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1120, Current, 15477);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1121_9461 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1120, Current, 0, 0, 15478);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1120, Current, 15478);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000DE, 0,0); /* Result */
...
/* {ETF_INT_PARAM}.out */
EIF_TYPED_VALUE F1121_9462 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1120, Current, 0, 0, 15479);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1120, Current, 15479);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000DE, 0,0); /* Result */
