...
extern void F1143_9547(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1143_9548(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1143_9549(EIF_REFERENCE);
extern void F1143_9550(EIF_REFERENCE);
extern void F1143_9551(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1143_9547 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1142, Current, 1, 0, 15567);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1142, Current, 15567);
	RTIV(Current, RTAL);
	wstdinit(loc1,loc1);
	RTLXI(loc1);
	RTHOOK(1);
	...
	RTHOOK(2);
	RTDBGAA(Current, dtype, 7274, 0xF80003CE, 0); /* model */
	...
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(7274, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTDBGLE;
...
EIF_TYPED_VALUE F1143_9548 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1143_9549 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1142, Current, 0, 0, 15564);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1142, Current, 15564);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTHOOK(2);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7274, Dtype(Current)))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(2,1);
...
void F1143_9550 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1142, Current, 0, 0, 15565);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1142, Current, 15565);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1143_9551 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1142, Current, 1, 1, 15566);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1142, Current, 15566);
	RTCC(arg1, 1142, l_feature_name, 1, eif_new_type(1209, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(ti4_1 == ((EIF_INTEGER_32) 0L))) {
		...
		*(EIF_REFERENCE *)(Current + RTWA(7266, dtype)) = (EIF_REFERENCE) RTCCL(tr2);
		...
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7266, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		RTNHOOK(4,1);
		tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7275, dtype))(Current)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
		ur1 = RTCCL(tr2);
