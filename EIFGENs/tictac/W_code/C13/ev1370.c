...
extern void F1370_12610(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1370_12611(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1370_12612(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1370_12613(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1370_12614(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1370_12615(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1370_12616(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1370_12617(EIF_REFERENCE);
...
void F1370_12610 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1369, Current, 0, 1, 19053);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1369, Current, 19053);
	RTCC(arg1, 1369, l_feature_name, 1, RTWCT(9362, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
void F1370_12611 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1369, Current, 0, 0, 19054);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1369, Current, 19054);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ub1 = (EIF_BOOLEAN) 1;
...
RTOID (F1370_12612)
EIF_TYPED_VALUE F1370_12612 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1369, Current, 1, 0, 19055);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1369, Current, 19055);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(8339, "readable_pixbuf_formats", loc1))(loc1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(4,1);
...
EIF_TYPED_VALUE F1370_12613 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1369, Current, 0, 0, 19056);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1369, Current, 19056);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1370_12614 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1369, Current, 0, 0, 19057);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1369, Current, 19057);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
...
EIF_TYPED_VALUE F1370_12615 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1369, Current, 0, 0, 19058);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1369, Current, 19058);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
	tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5119, 959))(Current)).it_p);
...
EIF_TYPED_VALUE F1370_12616 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1369, Current, 0, 0, 19059);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1369, Current, 19059);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = RTMS_EX_H("which lpr > /dev/null 2>&1",26,1593044529);
	ur1 = tr1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(3041, dtype))(Current, ur1x);
	RTHOOK(2);
...
RTOID (F1370_12617)
EIF_TYPED_VALUE F1370_12617 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1369, Current, 1, 0, 19052);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1369, Current, 19052);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 1, 0xF800055D, 0, 0); /* loc1 */
	...
	RTHOOK(3);
	RTDBGAL(Current, 0, 0xF80000F9, 0,0); /* Result */
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(8356, "font_names_on_system", loc1))(loc1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(3,1);
	tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1705, "linear_representation", tr1))(tr1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	Result = (EIF_REFERENCE) RTCCL(tr2);
	RTHOOK(4);
...
{
	GTCX
	RTOTS (12612,F1370_12612)
	RTOTS (12617,F1370_12617)
}
