...
extern EIF_TYPED_VALUE F1325_11997(EIF_REFERENCE);
extern void F1325_11998(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1325_11997 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1325_11998 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1324, Current, 0, 0, 18558);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1324, Current, 18558);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8428, 0xF80005D2, 0); /* implementation */
