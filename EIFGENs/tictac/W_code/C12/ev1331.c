...
extern EIF_TYPED_VALUE F1331_12026(EIF_REFERENCE);
extern void F1331_12027(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1331_12026 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1331_12027 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1330, Current, 0, 0, 18587);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1330, Current, 18587);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8428, 0xF80005DC, 0); /* implementation */
