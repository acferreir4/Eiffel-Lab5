...
extern EIF_TYPED_VALUE F1086_9096(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1086_9096 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1085, Current, 0, 0, 15185);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1085, Current, 15185);
	RTIV(Current, RTAL);
	RTHOOK(1);
