...
extern EIF_TYPED_VALUE F1111_9435(EIF_REFERENCE);
...
RTOID (F1111_9435)
EIF_TYPED_VALUE F1111_9435 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1110, Current, 0, 0, 15454);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1110, Current, 15454);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
