...
extern EIF_TYPED_VALUE F1159_9934(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1159_9934 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1158, Current, 0, 0, 15942);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1158, Current, 15942);
	RTIV(Current, RTAL);
