...
extern EIF_TYPED_VALUE F1158_9933(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1158_9933 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1157, Current, 0, 0, 15941);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1157, Current, 15941);
	RTIV(Current, RTAL);
