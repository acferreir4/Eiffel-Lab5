...
extern EIF_TYPED_VALUE F1175_10207(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1175_10207 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1174, Current, 0, 1, 16375);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1174, Current, 16375);
	RTCC(arg1, 1174, l_feature_name, 1, eif_new_type(222, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
