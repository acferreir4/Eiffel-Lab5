...
extern EIF_TYPED_VALUE F1167_10087(EIF_REFERENCE);
...
RTOID (F1167_10087)
EIF_TYPED_VALUE F1167_10087 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1166, Current, 0, 0, 16236);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1166, Current, 16236);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
