...
static const EIF_TYPE_INDEX egt_13_999 [] = {0xFF01,222,0xFFFF};
static const EIF_TYPE_INDEX egt_14_999 [] = {0xFF01,300,0xFF01,222,0xFFFF};
static const EIF_TYPE_INDEX egt_15_999 [] = {0xFF01,300,0xFF01,222,0xFFFF};
static const EIF_TYPE_INDEX egt_16_999 [] = {0xFF01,300,0xFF01,222,0xFFFF};
static const EIF_TYPE_INDEX egt_17_999 [] = {0xFF01,300,0xFF01,222,0xFFFF};
static const EIF_TYPE_INDEX egt_18_999 [] = {0xFF01,222,0xFFFF};
static const EIF_TYPE_INDEX egt_19_999 [] = {0xFF01,222,0xFFFF};
static const EIF_TYPE_INDEX egt_20_999 [] = {0xFF01,222,0xFFFF};
...
static const struct desc_info desc_999[] = {
	...
	{EIF_GENERIC(egt_13_999), 14706, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_999), 14707, 0xFFFFFFFF},
	{EIF_GENERIC(egt_15_999), 14708, 0xFFFFFFFF},
	{EIF_GENERIC(egt_16_999), 14709, 0xFFFFFFFF},
	{EIF_GENERIC(egt_17_999), 14710, 0xFFFFFFFF},
	{EIF_GENERIC(egt_18_999), 14713, 0xFFFFFFFF},
	{EIF_GENERIC(egt_19_999), 14711, 0xFFFFFFFF},
	{EIF_GENERIC(egt_20_999), 14712, 0xFFFFFFFF},
};
void Init999(void)
{
	IDSC(desc_999, 0, 998);
	IDSC(desc_999 + 1, 1, 998);
	IDSC(desc_999 + 32, 778, 998);
}
