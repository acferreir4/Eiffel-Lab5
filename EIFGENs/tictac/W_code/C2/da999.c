...
extern EIF_TYPED_VALUE F999_8540(EIF_REFERENCE);
extern EIF_TYPED_VALUE F999_8541(EIF_REFERENCE);
extern EIF_TYPED_VALUE F999_8542(EIF_REFERENCE);
extern EIF_TYPED_VALUE F999_8543(EIF_REFERENCE);
extern EIF_TYPED_VALUE F999_8544(EIF_REFERENCE);
extern EIF_TYPED_VALUE F999_8545(EIF_REFERENCE);
extern EIF_TYPED_VALUE F999_8546(EIF_REFERENCE);
extern EIF_TYPED_VALUE F999_8547(EIF_REFERENCE);
...
EIF_TYPED_VALUE F999_8540 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F999_8540,14707,RTMS_EX_H("English",7,257590376));
}

/* {DATE_TIME_TOOLS}.days_text */
RTOID (F999_8541)
EIF_TYPED_VALUE F999_8541 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 998, Current, 0, 0, 14707);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(998, Current, 14707);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {299,0xFF01,222,0xFFFF};
		EIF_TYPE typres0;
...
RTOID (F999_8542)
EIF_TYPED_VALUE F999_8542 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 998, Current, 0, 0, 14708);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(998, Current, 14708);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF800012C, 0,0); /* Result */
...
RTOID (F999_8543)
EIF_TYPED_VALUE F999_8543 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 998, Current, 0, 0, 14709);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(998, Current, 14709);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF800012C, 0,0); /* Result */
...
RTOID (F999_8544)
EIF_TYPED_VALUE F999_8544 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 998, Current, 0, 0, 14710);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(998, Current, 14710);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF800012C, 0,0); /* Result */
...
EIF_TYPED_VALUE F999_8545 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F999_8545,14712,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
EIF_TYPED_VALUE F999_8546 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F999_8546,14713,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
EIF_TYPED_VALUE F999_8547 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F999_8547,14714,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}

void EIF_Minit999 (void)
{
	GTCX
	RTOTS (8540,F999_8540)
	RTOTS (8541,F999_8541)
	RTOTS (8542,F999_8542)
	RTOTS (8543,F999_8543)
	RTOTS (8544,F999_8544)
	RTOTS (8545,F999_8545)
	RTOTS (8546,F999_8546)
	RTOTS (8547,F999_8547)
}
