...
static const EIF_TYPE_INDEX egt_13_1000 [] = {0xFF01,1065,0xFFFF};
static const EIF_TYPE_INDEX egt_14_1000 [] = {0xFF01,1191,0xFFFF};
static const EIF_TYPE_INDEX egt_15_1000 [] = {0xFF01,1193,0xFFFF};
static const EIF_TYPE_INDEX egt_16_1000 [] = {0xFF01,1193,0xFFFF};
...
static const struct desc_info desc_1000[] = {
	...
	{EIF_GENERIC(egt_13_1000), 14714, 0},
	{EIF_GENERIC(egt_14_1000), 14715, 0xFFFFFFFF},
	{EIF_GENERIC(egt_15_1000), 14716, 0xFFFFFFFF},
	{EIF_GENERIC(egt_16_1000), 14717, 0xFFFFFFFF},
};
void Init1000(void)
{
	IDSC(desc_1000, 0, 999);
	IDSC(desc_1000 + 1, 1, 999);
	IDSC(desc_1000 + 32, 773, 999);
}
