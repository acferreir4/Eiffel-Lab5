...
extern EIF_TYPED_VALUE F1013_8670(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1013_8671(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1013_8670 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1013_8671 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1012, Current, 0, 0, 14840);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1012, Current, 14840);
	RTIV(Current, RTAL);
	RTHOOK(1);
