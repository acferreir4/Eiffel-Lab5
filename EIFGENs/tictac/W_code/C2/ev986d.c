...
static const EIF_TYPE_INDEX egt_13_986 [] = {0xFF01,1058,0xFFFF};
static const EIF_TYPE_INDEX egt_14_986 [] = {0xFF01,1181,0xFFFF};
...
static const struct desc_info desc_986[] = {
	...
	{EIF_GENERIC(egt_13_986), 14612, 0},
	{EIF_GENERIC(egt_14_986), 14613, 0xFFFFFFFF},
};
void Init986(void)
{
	IDSC(desc_986, 0, 985);
	IDSC(desc_986 + 1, 1, 985);
	IDSC(desc_986 + 32, 922, 985);
}
