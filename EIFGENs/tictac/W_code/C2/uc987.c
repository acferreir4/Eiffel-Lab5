...
extern EIF_TYPED_VALUE F987_8425(EIF_REFERENCE);
...
RTOID (F987_8425)
EIF_TYPED_VALUE F987_8425 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 986, Current, 0, 0, 14617);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(986, Current, 14617);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
