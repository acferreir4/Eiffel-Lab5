...
extern EIF_TYPED_VALUE F1010_8601(EIF_REFERENCE);
...
RTOID (F1010_8601)
EIF_TYPED_VALUE F1010_8601 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1009, Current, 0, 0, 14764);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1009, Current, 14764);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
