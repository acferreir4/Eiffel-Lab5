...
static const EIF_TYPE_INDEX egt_13_1013 [] = {0xFF01,1073,0xFFFF};
static const EIF_TYPE_INDEX egt_14_1013 [] = {0xFF01,1194,0xFFFF};
...
static const struct desc_info desc_1013[] = {
	...
	{EIF_GENERIC(egt_13_1013), 14839, 0},
	{EIF_GENERIC(egt_14_1013), 14840, 0xFFFFFFFF},
};
void Init1013(void)
{
	IDSC(desc_1013, 0, 1012);
	IDSC(desc_1013 + 1, 1, 1012);
	IDSC(desc_1013 + 32, 645, 1012);
}
