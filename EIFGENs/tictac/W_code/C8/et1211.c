...
extern void F1211_10469(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1211_10470(EIF_REFERENCE);
extern void EIF_Minit1211(void);
extern EIF_REFERENCE _A1211_51();
...
/* {ETF_DUMMY}.make */
void F1211_10469 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ur3 ur3x.it_r
	...
	RTEAA(l_feature_name, 1210, Current, 0, 3, 16893);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1210, Current, 16893);
	RTCC(arg1, 1210, l_feature_name, 1, eif_new_type(222, 0x01), 0x01);
	{
	...
	RTCC(arg3, 1210, l_feature_name, 3, eif_new_type(1035, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
	ur2 = RTCCL(arg2);
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr2 = RTLNRW(typres0.id, 0, (EIF_POINTER) _A1211_51, (EIF_POINTER)(0),8045, 0, 0, 1, -1, tr1, 0);
	}
	RTAR(Current, tr2);
...
/* {ETF_DUMMY}.etf_dummy */
void F1211_10470 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1210, Current, 0, 0, 16894);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1210, Current, 16894);
	RTIV(Current, RTAL);
	RTHOOK(1);
