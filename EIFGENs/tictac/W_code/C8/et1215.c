...
extern void F1215_10476(EIF_REFERENCE);
...
/* {ETF_REDO}.redo */
void F1215_10476 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1214, Current, 0, 0, 16898);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1214, Current, 16898);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(6232, "redo", tr1))(tr1);
	RTHOOK(2);
