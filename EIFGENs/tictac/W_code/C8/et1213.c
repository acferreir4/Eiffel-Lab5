...
extern void F1213_10473(EIF_REFERENCE);
...
/* {ETF_UNDO}.undo */
void F1213_10473 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1212, Current, 0, 0, 16896);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1212, Current, 16896);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(6231, "undo", tr1))(tr1);
	RTHOOK(2);
