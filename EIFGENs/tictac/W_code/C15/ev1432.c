...
static EIF_TYPED_VALUE F1432_13615_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1432_13615(EIF_REFERENCE);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1431, Current, 6, 0, 19870);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1431, Current, 19870);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	loc2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10402, dtype))(Current)).it_i4);
	RTHOOK(4);
	tb1 = '\0';
	...
	if (tb1) {
		...
		if (!tb2) {
			...
			if ((EIF_BOOLEAN)(ti4_1 == ((EIF_INTEGER_32) 1L))) {
				...
				tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6961, dtype))(Current)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
				tb2 = RTCEQ(tr1, tr2);
			}
			tb1 = tb2;
		}
		if (tb1) {
			RTHOOK(6);
			RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
			Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10321, dtype))(Current)).it_i4);
			...
			if ((EIF_BOOLEAN) (loc2 < ti4_1)) {
				...
				loc4 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10395, dtype))(Current)).it_i4);
				for (;;) {
					RTHOOK(11);
					...
					if ((EIF_BOOLEAN) ((EIF_BOOLEAN) (loc2 >= loc4) && (EIF_BOOLEAN) (loc2 <= loc3))) {
						...
						loc6 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10396, dtype))(Current)).it_i4);
						...
						if ((EIF_BOOLEAN) (loc2 > loc6)) {
							RTHOOK(20);
							RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
							Result = *(EIF_INTEGER_32 *)(Current + RTWA(9954, dtype));
							Result = (EIF_INTEGER_32) (EIF_INTEGER_32) (Result + ((EIF_INTEGER_32) 1L));
						} else {
							RTHOOK(21);
							RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
...
/* {EV_BOX_I}.interface */
static EIF_TYPED_VALUE F1432_13615_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1431, Current, 0, 0, 19871);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1431, Current, 19871);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1432_13615 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9362, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1432_13615_body (Current)).it_r;
