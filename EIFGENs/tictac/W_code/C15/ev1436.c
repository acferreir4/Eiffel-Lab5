...
extern void F1436_13635(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1436_13636(EIF_REFERENCE);
static EIF_TYPED_VALUE F1436_13637_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1436_13637(EIF_REFERENCE);
...
void F1436_13635 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1435, Current, 0, 1, 19894);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1435, Current, 19894);
	RTCC(arg1, 1435, l_feature_name, 1, RTWCT(9362, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
void F1436_13636 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1435, Current, 0, 0, 19895);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1435, Current, 19895);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
static EIF_TYPED_VALUE F1436_13637_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1435, Current, 0, 0, 19896);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1435, Current, 19896);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1436_13637 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9362, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1436_13637_body (Current)).it_r;
