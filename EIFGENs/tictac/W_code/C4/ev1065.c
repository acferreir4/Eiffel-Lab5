...
extern EIF_TYPED_VALUE F1065_8971(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1065_8971 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1064, Current, 0, 0, 15089);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1064, Current, 15089);
	RTIV(Current, RTAL);
	RTHOOK(1);
