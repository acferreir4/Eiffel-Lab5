...
extern EIF_TYPED_VALUE F1060_8959(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1060_8959 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1059, Current, 0, 0, 15080);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1059, Current, 15080);
	RTIV(Current, RTAL);
	RTHOOK(1);
