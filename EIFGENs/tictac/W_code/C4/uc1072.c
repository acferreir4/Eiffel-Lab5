...
extern EIF_TYPED_VALUE F1072_9006(EIF_REFERENCE);
...
RTOID (F1072_9006)
EIF_TYPED_VALUE F1072_9006 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1071, Current, 0, 0, 15104);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1071, Current, 15104);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
