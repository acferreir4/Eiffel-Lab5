...
extern EIF_TYPED_VALUE F1073_9007(EIF_REFERENCE);
...
RTOID (F1073_9007)
EIF_TYPED_VALUE F1073_9007 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1072, Current, 0, 0, 15105);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1072, Current, 15105);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
