...
/* {EV_TREE_I}.make */
void F1455_13926 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1454, Current, 0, 0, 20131);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1454, Current, 20131);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {EV_TREE_I}.interface */
static EIF_TYPED_VALUE F1455_13930_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1454, Current, 0, 0, 20132);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1454, Current, 20132);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1455_13930 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9362, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1455_13930_body (Current)).it_r;
