...
extern void F1478_14297(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1478_14298(EIF_REFERENCE);
static EIF_TYPED_VALUE F1478_14299_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1478_14299(EIF_REFERENCE);
...
void F1478_14297 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1477, Current, 0, 1, 20381);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1477, Current, 20381);
	RTCC(arg1, 1477, l_feature_name, 1, RTWCT(9362, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
void F1478_14298 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1477, Current, 1, 0, 20382);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1477, Current, 20382);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	loc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5788, 960))(Current)).it_p);
	RTHOOK(3);
	up1 = loc1;
	...
	RTHOOK(6);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9357, 1476))(Current);
	if (RTAL & CK_ENSURE) {
		RTHOOK(7);
...
static EIF_TYPED_VALUE F1478_14299_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1477, Current, 0, 0, 20383);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1477, Current, 20383);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1478_14299 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9362, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1478_14299_body (Current)).it_r;
