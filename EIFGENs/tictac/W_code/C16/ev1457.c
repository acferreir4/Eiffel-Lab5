...
extern EIF_TYPED_VALUE F1457_13976(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1457_13977(EIF_REFERENCE);
extern void F1457_13985(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1457_13986_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1457_13986(EIF_REFERENCE);
extern void F1457_16510(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F1457_13976 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1457_13977 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1456, Current, 2, 0, 20159);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1456, Current, 20159);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1457_13985 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1456, Current, 2, 1, 20155);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1456, Current, 20155);
	RTIV(Current, RTAL);
...
static EIF_TYPED_VALUE F1457_13986_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1456, Current, 0, 0, 20156);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1456, Current, 20156);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1457_13986 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9362, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1457_13986_body (Current)).it_r;
...
void F1457_16510 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1456, Current, 0, 16509);
	RTSA(dtype);
	RTME(dtype, 0);
