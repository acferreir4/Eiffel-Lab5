...
static const EIF_TYPE_INDEX egt_13_981 [] = {0xFF01,1050,0xFFFF};
static const EIF_TYPE_INDEX egt_14_981 [] = {0xFF01,1194,0xFFFF};
static const EIF_TYPE_INDEX egt_15_981 [] = {0xFF01,1194,0xFFFF};
...
static const struct desc_info desc_981[] = {
	...
	{EIF_GENERIC(egt_13_981), 14596, 0},
	{EIF_GENERIC(egt_14_981), 14597, 0xFFFFFFFF},
	{EIF_GENERIC(egt_15_981), 14598, 0xFFFFFFFF},
};
void Init981(void)
{
	IDSC(desc_981, 0, 980);
	IDSC(desc_981 + 1, 1, 980);
	IDSC(desc_981 + 32, 967, 980);
}
