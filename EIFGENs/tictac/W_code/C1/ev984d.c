...
static const EIF_TYPE_INDEX egt_13_984 [] = {0xFF01,1054,0xFFFF};
static const EIF_TYPE_INDEX egt_14_984 [] = {0xFF01,1189,0xFFFF};
...
static const struct desc_info desc_984[] = {
	...
	{EIF_GENERIC(egt_13_984), 14608, 0},
	{EIF_GENERIC(egt_14_984), 14609, 0xFFFFFFFF},
};
void Init984(void)
{
	IDSC(desc_984, 0, 983);
	IDSC(desc_984 + 1, 1, 983);
	IDSC(desc_984 + 32, 931, 983);
}
