...
extern EIF_TYPED_VALUE F1534_15305(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1534_15305 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1533, Current, 0, 0, 21293);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1533, Current, 21293);
	RTIV(Current, RTAL);
	RTHOOK(1);
