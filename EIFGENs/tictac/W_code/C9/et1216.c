...
extern void F1216_10477(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void EIF_Minit1216(void);
extern EIF_REFERENCE _A1216_51();
...
void F1216_10477 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ur3 ur3x.it_r
	...
	RTEAA(l_feature_name, 1215, Current, 0, 3, 16899);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1215, Current, 16899);
	RTCC(arg1, 1215, l_feature_name, 1, eif_new_type(222, 0x01), 0x01);
	{
	...
	RTCC(arg3, 1215, l_feature_name, 3, eif_new_type(1035, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
	ur2 = RTCCL(arg2);
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr2 = RTLNRW(typres0.id, 0, (EIF_POINTER) _A1216_51, (EIF_POINTER)(0),8048, 0, 0, 1, -1, tr1, 0);
	}
	RTAR(Current, tr2);
