...
extern EIF_TYPED_VALUE F1224_10538(EIF_REFERENCE);
...
RTOID (F1224_10538)
EIF_TYPED_VALUE F1224_10538 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1223, Current, 0, 0, 17009);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1223, Current, 17009);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
